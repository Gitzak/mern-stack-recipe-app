...
const SendMailToUser = async ({ userId, userEmail, userPassword }) => {
                  ...
                  <td bgcolor="#426899" align="center" style="padding: 0px 10px 0px 10px;">
                     <table border="0" cellpadding="0" cellspacing="0" width="480" >
                        <tr>
                           ...
                           <h1 style="font-size: 24px; color: #333333; margin-bottom: 20px;">Welcome !</h1>
                                       ...
                                       <table border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                             <td align="left" style="border-radius: 3px;" bgcolor="#426899">
                                                <a href="${config.app.origin_front}/validate/${userId}" target="_blank" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; color: #ffffff; text-decoration: none; padding: 11px 22px; border-radius: 2px; border: 1px solid #0055c5; display: inline-block;">Validate your Account</a>
                                             </td>
                                          </tr>
                                       </table>
                                    </td>
